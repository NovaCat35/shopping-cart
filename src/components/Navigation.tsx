...
function Navigation() {
	...
	return (
		<nav className={`z-20 bg-white bg-opacity-40 px-3 py-3 flex justify-between items-center sticky top-0 z-10 transition-transform duration-300 transform ${show ? "translate-y-0" : "-translate-y-full"}`}>
